  ...
  return (
    <div className="min-h-screen bg-[#f0f4fb] flex flex-col font-sans text-[#243118]">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* Sidebar Navigation */}
        <aside className="w-64 bg-[#081830] text-slate-200 p-4 space-y-1 overflow-y-auto shrink-0 border-r border-blue-900 shadow-xl">
          <div className="px-3 py-2 text-[10px] font-mono font-bold text-blue-400 uppercase tracking-wider border-b border-blue-800/80 mb-2">
          ...
          <div className="pt-4 border-t border-blue-800/80 mt-4">
            <button
